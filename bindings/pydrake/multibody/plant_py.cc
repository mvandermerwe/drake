            ...
            void DoScalarDependentDefinitions(py::module m, T) {
                ...
                // HydroelasticContactInfo
                {
                    ...
                    cls  // BR
                            ...
                            .def("quadrature_point_data", &Class::quadrature_point_data,
                                 cls_doc.quadrature_point_data.doc);
                    DefCopyAndDeepCopy(&cls);
                ...
                {
                    using Class = HydroelasticQuadraturePointData<T>;
                    constexpr auto &cls_doc = doc.HydroelasticQuadraturePointData;
                    auto cls = DefineTemplateClassWithDefault<Class>(m, "HydroelasticQuadraturePointData", param,
                                                                     cls_doc.doc);
                    cls
                            .def_readwrite("p_WQ", &Class::p_WQ, cls_doc.p_WQ.doc)
...

                {
                    ...
                    cls  // BR
                            ...
                            .def("CalcCenterOfMassPositionInWorld",
                                 overload_cast_explicit < Vector3 < T > ,
                    const Context <T>&>(
                                    ...
                                    [](const Class *self, const Context <T> &context,
                                       ...
                                       const Frame <T> &frame_A, const Frame <T> &frame_E) {
                                        ...
                                        self->CalcJacobianTranslationalVelocity(context, with_respect_to,
                                                                                frame_B, p_BoBi_B, frame_A, frame_E,
                                                                                &Js_v_ABi_E);
                                        return Js_v_ABi_E;
                                    },
                                    py::arg("context"), py::arg("with_respect_to"), py::arg("frame_B"),
                                    ...
                                    [](const Class *self, const Context <T> &context,
                                       ...
                                       const Frame <T> &frame_A, const Frame <T> &frame_E) {
                                        return self->CalcBiasTranslationalAcceleration(context,
                                                                                       with_respect_to, frame_B,
                                                                                       p_BoBi_B, frame_A, frame_E);
                                    },
                                    py::arg("context"), py::arg("with_respect_to"), py::arg("frame_B"),
                                    py::arg("p_BoBi_B"), py::arg("frame_A"), py::arg("frame_E"),
...
#pragma GCC diagnostic pop
        ...
        doc() = "Bindings for MultibodyPlant and related classes.";
        ...
        // ContactResultsToLcmSystem
    {
        ...
        py::class_ <Class, systems::LeafSystem<T>>(
                m,
        "ContactResultsToLcmSystem", cls_doc.doc)
        .
...
.ConnectContactResultsToDrakeVisualizer.doc_5args);
...
py::enum_<Class>(m,
"DiscreteContactSolver", cls_doc.doc)
...
py::class_<Class, PhysicalModel < T>>
cls(m,
"DeformableModel", cls_doc.doc);
cls  // BR
.
def(py::init<MultibodyPlant < T>
*>(), cls_doc.ctor.doc)
.def("num_bodies", &Class::num_bodies, cls_doc.num_bodies.doc)
...
"GetBodyId",
[](
const Class *self, geometry::GeometryId
geometry_id) {
return self->
GetBodyId(geometry_id);
},
...
BindIdentifier<DeformableBodyId>(
        m,
"DeformableBodyId", doc.DeformableBodyId.doc);
}
